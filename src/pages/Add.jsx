    ...
    const handleSubmit = async (e) => {
        ...
        if (skuValid && nameValid && descValid && imgValid && costValid && sellValid && catValid && storValid && quantValid && disValid) {
            const product = {
                ...
                "productName": e.target.form[2].value ? e.target.form[2].value : "No Name",
                "productDescription": e.target.form[3].value ? e.target.form[3].value : "No Description",
                "productImage": await getBase64(e.target.form[4].files[0]),
                "productCostPrice": e.target.form[5].value ? parseFloat(e.target.form[5].value) : 0,
                "productSellingPrice": e.target.form[6].value ? parseFloat(e.target.form[6].value) : 0,
                "productCategoryName": e.target.form[7].value ? e.target.form[7].value : "No Category",
                ...
                <div className="space-y-12">
                    <div className="pb-12">
                        ...
                        <p className="mt-1 text-sm leading-6 text-gray-600">
                            This information will be displayed in the inventory so be careful what you enter.
                        </p>
                        ...
                        <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                            <div className="sm:col-span-3">
                                ...
                                {skuValid === false && <span className="flex items-center font-medium tracking-wide text-red-500 text-xs mt-1 ml-1">
                                    Invalid SKU field !
                                </span>}
                            </div>
                            <div className="sm:col-span-3">
                                ...
                                <div className="mt-2">
                                    <input
                                        ...
                                        onBlur={(e) => e.target.value === '' ? setNameValid(false) : setNameValid(true)}
                                    />
                                </div>
                                {nameValid === false && <span className="flex items-center font-medium tracking-wide text-red-500 text-xs mt-1 ml-1">
                                    Invalid name field !
                                </span>}
                            </div>
                            ...
                            <div className="col-span-full">
                                ...
                                <div className="mt-2">
                                    <textarea
                                        ...
                                        rows={4}
                                        className="block w-full rounded-md border-0 py-1.5 px-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-sky-600 sm:text-sm sm:leading-6"
                                        onBlur={(e) => e.target.value === '' ? setDescValid(false) : setDescValid(true)}
                                    />
                                </div>
                                {descValid === false && <span className="flex items-center font-medium tracking-wide text-red-500 text-xs mt-1 ml-1">
                                    Invalid description field !
                                </span>}
                                <p className="mt-3 text-sm leading-6 text-gray-600">Write a few words about the product</p>
                            </div>
                            ...
                            <div className="col-span-full">
                                        ...
                                        <div className="mt-4 flex text-sm leading-6 text-gray-600">
                                            ...
                                            >
                                                ...
                                                <input
                                                    ...
                                                    type="file"
                                                    className="sr-only"
                                                    onBlur={(e) => e.target.files.length === 0 ? setImgValid(false) : setImgValid(true)} />
                                            </label>
                                ...
                                {imgValid === false && <span className="flex items-center font-medium tracking-wide text-red-500 text-xs mt-1 ml-1">
                                    Invalid image field !
                                </span>}
                            </div>
                        </div>
                        ...
                        <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                            <div className="sm:col-span-3">
                                <label htmlFor="cost-price" className="block text-sm font-medium leading-6 text-gray-900">
                                    Cost Price
                                </label>
                                <div className="relative mt-2 rounded-md shadow-sm">
                                    ...
                                    <input
                                        ...
                                        onBlur={(e) => e.target.value === '' ? setCostValid(false) : setCostValid(true)}
                                    />
                                ...
                                {costValid === false && <span className="flex items-center font-medium tracking-wide text-red-500 text-xs mt-1 ml-1">
                                    Invalid cost price field !
                                </span>}
                            </div>

                            <div className="sm:col-span-3">
                                <label htmlFor="selling-price" className="block text-sm font-medium leading-6 text-gray-900">
                                    Selling Price
                                </label>
                                <div className="relative mt-2 rounded-md shadow-sm">
                                    <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
                                    ...
                                    <input
                                        ...
                                        placeholder="0.00"
                                        aria-describedby="price-currency"
                                        onBlur={(e) => e.target.value === '' ? setSellValid(false) : setSellValid(true)}
                                    />
                                    <div className="pointer-events-none absolute inset-y-0 right-0 flex items-center pr-3">
                                        <span className="text-gray-500 sm:text-sm" id="price-currency">
                                            CAD
                                ...
                                {sellValid === false && <span className="flex items-center font-medium tracking-wide text-red-500 text-xs mt-1 ml-1">
                            ...
                            <div className="sm:col-span-3">
                                <label htmlFor="storage-type" className="block text-sm font-medium leading-6 text-gray-900">
                                    Storage Type
                                </label>
                                <div className="mt-2">
                                    <select
                            ...
                            <div className="sm:col-span-3">
                                ...
                                <div className="mt-2">
                                    <input
                                        ...
                                        id="quantity"
                                        className="block w-full rounded-md border-0 py-1.5 px-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-sky-600 sm:text-sm sm:leading-6"
                                        onBlur={(e) => e.target.value === '' ? setQuantValid(false) : setQuantValid(true)}
                                    />
                                </div>
                            ...
                            <div className="sm:col-span-3">
                                ...
                                <div className="mt-2">
                                    <input
                                        ...
                                        id="discount"
                                        className="block w-full rounded-md border-0 py-1.5 px-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-sky-600 sm:text-sm sm:leading-6"
                                        onBlur={(e) => e.target.value === '' ? setDisValid(false) : setDisValid(true)}
                                    />
                                </div>
                                {disValid === false && <span className="flex items-center font-medium tracking-wide text-red-500 text-xs mt-1 ml-1">
                            ...
                            <div className="flex justify-between md:justify-normal md:gap-44">
                                <div className="flex gap-x-3">
                                    ...
                                    <div className="text-sm leading-6">
                                        <label htmlFor="expirable" className="font-medium text-gray-900">
                                            Expirable?
                                        </label>
                                    </div>
                                </div>
                                {isExpirable && <div className=" flex gap-x-3">
                                    <div className="flex h-6 items-center">
                                        <input
                                            id="expiry-date"
                                            name="expiry-date"
                                    ...
                                    <div className="text-sm leading-6">
                                        <label htmlFor="expiry-date" className="font-medium text-gray-900">
                                            Expiry Date
                                        </label>
                                    </div>
                                </div>}
